...
echo "🚀 Step 1: Installing Android-Tools in Termux..."
pkg install android-tools -y || true

echo "📁 Step 2: Creating Local Android SDK Directory..."
SDK_DIR="$HOME/android-sdk"
mkdir -p "$SDK_DIR/licenses"

# Accept SDK Licenses automatically
echo -e "\n243337357737bbed22ecb35f81e07169f493a589" > "$SDK_DIR/licenses/android-sdk-license"

echo "📝 Step 3: Configuring local.properties..."
mkdir -p android
...
echo "📁 Step 4: Setting up Output Directory (/sdcard/HyperEditsPro_Official)..."
OUT_DIR="/sdcard/HyperEditsPro_Official"
mkdir -p "$OUT_DIR"

echo "🌐 Step 5: Generating Website Landing Page..."
cat << 'WEB_EOF' > "$OUT_DIR/index.html"
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
echo "🔑 Step 7: Moving APK to /sdcard/HyperEditsPro_Official..."
cp app/build/outputs/apk/debug/app-debug.apk "$OUT_DIR/HyperEditsPro_Signed.apk"

echo "===================================================="
echo "👑 SUCCESS! All Issues Resolved Cleanly!"

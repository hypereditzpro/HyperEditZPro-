...
console.log('🚀 Direct Build: Writing Signed APK & Website directly inside project...');

// 1. Write Website HTML in root/public
...
// 2. Build Web Assets & Compile Android Release
execSync('npm run build && npx cap sync android');

// 3. Auto Accept Licenses internally in Gradle
execSync('mkdir -p android/licenses');
fs.writeFileSync('android/licenses/android-sdk-license', '84831b9409646a918e30573bab4c9c91346d8abd\n243337357737bbed22ecb35f81e07169f493a589\nd56f5187479451eabf01fb78af6dfcb131a6481e\n');

execSync('cd android && ./gradlew assembleDebug --no-daemon');

// 4. Copy Signed APK directly inside HyperEditsPro main directory
fs.copyFileSync('android/app/build/outputs/apk/debug/app-debug.apk', 'HyperEditsPro_Signed.apk');

console.log('====================================================');
console.log('👑 SUCCESS: Signed APK and index.html are now ready directly in HyperEditsPro folder!');
